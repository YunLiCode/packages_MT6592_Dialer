.class public Lcom/android/contacts/common/util/HanziToPinyin;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/contacts/common/util/HanziToPinyin$Token;
    }
.end annotation
...
.field private static sInstance:Lcom/android/contacts/common/util/HanziToPinyin;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/contacts/common/util/HanziToPinyin;->UNIHANS:[C
    ...
    sput-object v0, Lcom/android/contacts/common/util/HanziToPinyin;->PINYINS:[[B
    ...
    sput-object v0, Lcom/android/contacts/common/util/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
...
.method protected constructor <init>(Z)V
    ...
    .line 272
    iput-boolean p1, p0, Lcom/android/contacts/common/util/HanziToPinyin;->mHasChinaCollator:Z
...
.method private addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    .prologue
    .line 593
    .local p2, "tokens":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/contacts/common/util/HanziToPinyin$Token;>;"
    ...
    new-instance v1, Lcom/android/contacts/common/util/HanziToPinyin$Token;

    invoke-direct {v1, p3, v0, v0}, Lcom/android/contacts/common/util/HanziToPinyin$Token;-><init>(ILjava/lang/String;Ljava/lang/String;)V
...
.method private static doSelfValidation()Z
    ...
    .line 301
    sget-object v9, Lcom/android/contacts/common/util/HanziToPinyin;->UNIHANS:[C
    ...
    sget-object v0, Lcom/android/contacts/common/util/HanziToPinyin;->UNIHANS:[C
    ...
    sget-object v9, Lcom/android/contacts/common/util/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
...
.method public static getInstance()Lcom/android/contacts/common/util/HanziToPinyin;
    .locals 5

    .prologue
    .line 276
    const-class v3, Lcom/android/contacts/common/util/HanziToPinyin;

    monitor-enter v3

    .line 277
    :try_start_0
    sget-object v2, Lcom/android/contacts/common/util/HanziToPinyin;->sInstance:Lcom/android/contacts/common/util/HanziToPinyin;
    ...
    .line 285
    new-instance v2, Lcom/android/contacts/common/util/HanziToPinyin;

    const/4 v4, 0x1

    invoke-direct {v2, v4}, Lcom/android/contacts/common/util/HanziToPinyin;-><init>(Z)V

    sput-object v2, Lcom/android/contacts/common/util/HanziToPinyin;->sInstance:Lcom/android/contacts/common/util/HanziToPinyin;
...
.method public static getPingYinFormString(Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    .param p0, "soucre"    # Ljava/lang/String;
    ...
    .line 600
    .local v2, "pingying":Ljava/lang/StringBuilder;
    invoke-static {}, Lcom/android/contacts/common/util/HanziToPinyin;->getInstance()Lcom/android/contacts/common/util/HanziToPinyin;

    move-result-object v4

    invoke-virtual {v4, p0}, Lcom/android/contacts/common/util/HanziToPinyin;->get(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v1

    .line 601
    .local v1, "pingYings":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/contacts/common/util/HanziToPinyin$Token;>;"
    ...
    check-cast v3, Lcom/android/contacts/common/util/HanziToPinyin$Token;

    .line 602
    .local v3, "token":Lcom/android/contacts/common/util/HanziToPinyin$Token;
    iget-object v4, v3, Lcom/android/contacts/common/util/HanziToPinyin$Token;->target:Ljava/lang/String;
    ...
    .line 604
    .end local v3    # "token":Lcom/android/contacts/common/util/HanziToPinyin$Token;
    :cond_0
...
.method private getToken(C)Lcom/android/contacts/common/util/HanziToPinyin$Token;
    .locals 26
    .param p1, "character"    # C

    .prologue
    .line 320
    new-instance v16, Lcom/android/contacts/common/util/HanziToPinyin$Token;

    invoke-direct/range {v16 .. v16}, Lcom/android/contacts/common/util/HanziToPinyin$Token;-><init>()V

    .line 321
    .local v16, "token":Lcom/android/contacts/common/util/HanziToPinyin$Token;
    ...
    iput-object v6, v0, Lcom/android/contacts/common/util/HanziToPinyin$Token;->source:Ljava/lang/String;
    ...
    iput v0, v1, Lcom/android/contacts/common/util/HanziToPinyin$Token;->type:I

    .line 327
    move-object/from16 v0, v16

    iput-object v6, v0, Lcom/android/contacts/common/util/HanziToPinyin$Token;->target:Ljava/lang/String;
    ...
    .line 334
    :cond_1
    sget-object v23, Lcom/android/contacts/common/util/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
    ...
    invoke-virtual {v0, v6, v1}, Ljava/text/Collator;->compare(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 362
    .local v10, "pinyin":Ljava/lang/StringBuilder;
    const/4 v5, 0x0

    .local v5, "j":I
    :goto_2
    sget-object v23, Lcom/android/contacts/common/util/HanziToPinyin;->PINYINS:[[B
    ...
    .line 343
    .end local v5    # "j":I
    .end local v10    # "pinyin":Ljava/lang/StringBuilder;
    .end local v15    # "tan":C
    :cond_4
    sget-object v23, Lcom/android/contacts/common/util/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
    ...
    .line 350
    sget-object v23, Lcom/android/contacts/common/util/HanziToPinyin;->UNIHANS:[C
    ...
    .restart local v10    # "pinyin":Ljava/lang/StringBuilder;
    .restart local v15    # "tan":C
    :cond_6
    invoke-virtual {v10}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/contacts/common/util/HanziToPinyin$Token;->target:Ljava/lang/String;

    .line 366
    const-string v23, "HanziToPinyin"

    new-instance v24, Ljava/lang/StringBuilder;

    invoke-direct/range {v24 .. v24}, Ljava/lang/StringBuilder;-><init>()V

    const-string v25, "getToken tan return="
    ...
    .line 380
    const-string v23, "oyzw"

    new-instance v24, Ljava/lang/StringBuilder;

    invoke-direct/range {v24 .. v24}, Ljava/lang/StringBuilder;-><init>()V

    const-string v25, "getToken shan return="
    ...
    const-string v25, "getToken qiu return="
    ...
    const-string v25, "getToken xie return="
    ...
    const-string v25, "getToken zhai return="
    ...
    const-string v25, "getToken zha return="
    ...
    const-string v25, "getToken po return="
    ...
    const-string v25, "getToken miao return="
    ...
    const-string v25, "getToken ou return="
    ...
    const-string v25, "getToken shen return="
    ...
    const-string v25, "getToken chang return="
    ...
    .line 511
    .local v17, "unihan":Ljava/lang/String;
    sget-object v23, Lcom/android/contacts/common/util/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
    ...
    .end local v4    # "end":I
    .end local v17    # "unihan":Ljava/lang/String;
    :cond_1e
    if-gez v3, :cond_1f
    ...
    .restart local v17    # "unihan":Ljava/lang/String;
    :cond_20
    if-lez v3, :cond_21
...
.method public get(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 539
    .local v6, "tokens":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/contacts/common/util/HanziToPinyin$Token;>;"
    iget-boolean v7, p0, Lcom/android/contacts/common/util/HanziToPinyin;->mHasChinaCollator:Z
    ...
    .line 554
    invoke-direct {p0, v3, v6, v5}, Lcom/android/contacts/common/util/HanziToPinyin;->addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    .line 569
    :cond_7
    invoke-direct {p0, v0}, Lcom/android/contacts/common/util/HanziToPinyin;->getToken(C)Lcom/android/contacts/common/util/HanziToPinyin$Token;

    move-result-object v4

    .line 570
    .local v4, "t":Lcom/android/contacts/common/util/HanziToPinyin$Token;
    iget v7, v4, Lcom/android/contacts/common/util/HanziToPinyin$Token;->type:I
    ...
    .line 580
    :cond_a
    iget v5, v4, Lcom/android/contacts/common/util/HanziToPinyin$Token;->type:I
    ...
    .end local v4    # "t":Lcom/android/contacts/common/util/HanziToPinyin$Token;
    :cond_b
    invoke-virtual {v3}, Ljava/lang/StringBuilder;->length()I
