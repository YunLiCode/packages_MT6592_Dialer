...
.method private allocate(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-static {v0, p2}, Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;->access$302(Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;Landroid/net/Uri;)Landroid/net/Uri;
...
.method private release()V
    ...
    # setter for: Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;->mQueryUri:Landroid/net/Uri;
    invoke-static {v0, v1}, Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;->access$302(Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;Landroid/net/Uri;)Landroid/net/Uri;
...
.method public static startQuery(ILandroid/content/Context;Landroid/net/Uri;Lcom/android/incallui/CallerInfoAsyncQuery$OnQueryCompleteListener;Ljava/lang/Object;)Lcom/android/incallui/CallerInfoAsyncQuery;
    .locals 9
    .param p0, "token"    # I
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "contactRef"    # Landroid/net/Uri;
    ...
    invoke-direct {v8, p1, p2}, Lcom/android/incallui/CallerInfoAsyncQuery;->allocate(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static startQuery(ILandroid/content/Context;Ljava/lang/String;Lcom/android/incallui/CallerInfoAsyncQuery$OnQueryCompleteListener;Ljava/lang/Object;)Lcom/android/incallui/CallerInfoAsyncQuery;
    .locals 10
    .param p0, "token"    # I
    .param p1, "context"    # Landroid/content/Context;
    ...
    const-string v1, "  - Treating number as a SIP address: xxxxxxx"
    ...
    .line 401
    iput-object p2, v2, Lcom/android/incallui/CallerInfoAsyncQuery$CookieWrapper;->number:Ljava/lang/String;
    ...
    .line 379
    .end local v2    # "cw":Lcom/android/incallui/CallerInfoAsyncQuery$CookieWrapper;
    .end local v3    # "contactRef":Landroid/net/Uri;
    .end local v5    # "selection":Ljava/lang/String;
    .end local v6    # "selectionArgs":[Ljava/lang/String;
    .end local v8    # "c":Lcom/android/incallui/CallerInfoAsyncQuery;
    :cond_0
    ...
    .line 406
    .restart local v2    # "cw":Lcom/android/incallui/CallerInfoAsyncQuery$CookieWrapper;
    .restart local v8    # "c":Lcom/android/incallui/CallerInfoAsyncQuery;
    :cond_1
    ...
    .line 409
    :cond_2
    iput v9, v2, Lcom/android/incallui/CallerInfoAsyncQuery$CookieWrapper;->event:I
...
# virtual methods
.method public addQueryListener(ILcom/android/incallui/CallerInfoAsyncQuery$OnQueryCompleteListener;Ljava/lang/Object;)V
    .locals 8
    .param p1, "token"    # I
    ...
    iget-object v1, p0, Lcom/android/incallui/CallerInfoAsyncQuery;->mHandler:Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;

    # getter for: Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;->mQueryUri:Landroid/net/Uri;
    invoke-static {v1}, Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;->access$300(Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;)Landroid/net/Uri;

    move-result-object v1

    invoke-static {v1}, Lcom/android/incallui/CallerInfoAsyncQuery;->sanitizeUriToString(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/incallui/CallerInfoAsyncQuery$CallerInfoAsyncQueryHandler;->toString()Ljava/lang/String;
    ...
    .line 432
    .local v2, "cw":Lcom/android/incallui/CallerInfoAsyncQuery$CookieWrapper;
    iput-object p2, v2, Lcom/android/incallui/CallerInfoAsyncQuery$CookieWrapper;->listener:Lcom/android/incallui/CallerInfoAsyncQuery$OnQueryCompleteListener;

    .line 433
    iput-object p3, v2, Lcom/android/incallui/CallerInfoAsyncQuery$CookieWrapper;->cookie:Ljava/lang/Object;
