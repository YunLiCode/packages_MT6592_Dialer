...
.method public addVoLteConfMember(ILjava/lang/String;)V
    ...
    .line 872
    const-string v1, "Cannot addVoLteConfMember, CallCommandService == null"
    ...
    const-string v2, "addVoLteConfMember, conferenceId = "
    ...
    invoke-interface {v1, p1, p2}, Lcom/android/services/telephony/common/ICallCommandService;->addVoLteConfMember(ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 880
    .local v0, "e":Landroid/os/RemoteException;
    const-string v1, "Error on addVoLteConfMember"
...
.method public startVoiceRecording()V
    ...
    invoke-interface {v1}, Lcom/android/services/telephony/common/ICallCommandService;->startVoiceRecording()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public unbindAfterUiUpdate()V
    ...
    .line 836
    const-string v1, "Cannot unbindAfterUIupdate(); CallCommandService == null"
    ...
    :cond_0
    :try_start_0
    const-string v1, "unbindAfterUIupdate, msg_what"
    ...
    invoke-interface {v1}, Lcom/android/services/telephony/common/ICallCommandService;->unbindAfterUiUpdate()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 843
    .local v0, "e":Landroid/os/RemoteException;
    const-string v1, "Error on unbindAfterUiUpdate"
